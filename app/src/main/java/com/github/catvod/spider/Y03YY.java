...
public class Y03YY extends Spider {
    ...
    public String playerContent(String flag, String id, List<String> vipFlags) throws Exception {
        ...
        if (TextUtils.isEmpty(playHtml)) {
            ...
            return buildParseResult(1, id);   // ← 修改为 parse=1
        }
        ...
        if (TextUtils.isEmpty(pn) || TextUtils.isEmpty(now)) {
            ...
            return direct != null ? direct : buildParseResult(1, id);  // ← 修改为 parse=1
        }
        ...
        SpiderDebug.log("[Y03YY] 所有解析方式失败，降级给壳子嗅探 parse=1");
        return buildParseResult(1, id);   // ← 最终兜底也改为 parse=1
    }
